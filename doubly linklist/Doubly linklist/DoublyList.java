...
public class DoublyList {
  ...
  /* triverse forward: prints the elements in the list */
  ...
  /* triverse backward: prints the elements in the list in reverse */
  ...
  public void insertStart(Object elem) {
    insert(elem, 0);
  }

  public void insertEnd(Object elem) {
    insert(elem, countNode() - 1);
  }
